---
title: Introduction
description: Who a Data Analyst is, what kinds of analysts exist, what stack the market demands, and where to start learning.
sidebar:
  order: 0
  label: Section overview
---

This section is the starting point. Before diving into SQL, Python and BI tools, it helps to understand the context: what a Data Analyst actually does, what flavors of the role exist, and where to look so you don't study "into the void".
